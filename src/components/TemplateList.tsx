        ...
        numbers.map(async (number) => {
          ...
          if (template.components?.header) {
            formattedComponents.push({
              type: "header",
              parameters: [{ type: "text", text: template.components.header.text }]
            });
          }
          ...
          if (template.components?.body) {
            formattedComponents.push({
              type: "body",
              parameters: [{ type: "text", text: template.components.body.text }]
            });
          }
          ...
          if (template.components?.buttons) {
            template.components.buttons.forEach((button, index) => {
              formattedComponents.push({
                ...
                parameters: button.text ? [{ type: "text", text: button.text }] : []
              });
            });
          }
